<template>
  <div class="ma-4">
    <h1>Privacy Policy for AMVSTRM</h1>
    <p>
      At amvstrm, accessible from amvstrm.vercel.app, one of our main priorities
      is the privacy of our visitors. This Privacy Policy document contains
      types of information that is collected and recorded by amvstrm and how we
      use it.
    </p>
    <p>
    ...
    <p>
      ...
      and/or collect in amvstrm. This policy is not applicable to any
    ...
    <h2>Log Files</h2>
    <p>
      amvstrm follows a standard procedure of using log files. These files log
    ...
    <p>
      Like any other website, amvstrm uses 'cookies'. These cookies are used to
    ...
    <P
      ...
      advertising partners of amvstrm.</P
    >
    <p>
      Third-party ad servers or ad networks uses technologies like cookies,
      JavaScript, or Web Beacons that are used in their respective
      advertisements and links that appear on amvstrm, which are sent directly
    ...
    <p>
      Note that amvstrm has no access to or control over these cookies that are
      used by third-party advertisers.
    </p>
    <h2>Third Party Privacy Policies</h2>
    <p>
      amvstrm's Privacy Policy does not apply to other advertisers or websites.
    ...
    <p>
      amvstrm does not knowingly collect any Personal Identifiable Information
