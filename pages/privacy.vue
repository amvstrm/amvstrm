  ...
  head(){
    return {
      ...
      meta: [
        ...
        { name: 'og:title', content: 'Privacy Policy | amvstrm' },
        {
          name: 'og:description',
          content:
            'About Privacy Policy at amvstr.ml',
        },
        { name: 'og:url', content: 'https://amvstrm.com/privacy' },
        { name: 'og:site_name', content: 'Privacy Policy | amvstrm' },
        { name: 'og:locale', content: 'en_US' },
        { name: 'twitter:card', content: 'summary_large_image' },
        { name: 'twitter:site', content: 'https://amvstr.ml/privacy' },
        { name: 'twitter:title', content: 'Privacy Policy | amvstrm' },
        {
